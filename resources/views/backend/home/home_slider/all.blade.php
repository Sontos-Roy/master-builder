...
@section('content')
    <div class="container">
        ...
        <div class="d-flex justify-content-between">
            <h4>Home Slider Section</h4>
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#Slider">
                Create Slider
              </button>
        </div>
        ...
        <br><br>
        <h4>For Home Page Carousel Slider</h4>
        <img src="{{ getImage('info', 'homeslider.png') }}" alt="" class="col-12">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="{{ route('home_slider.store') }}" enctype="multipart/form-data" id="ajax_form">
                    @csrf
